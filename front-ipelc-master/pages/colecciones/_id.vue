<template>
  <div>
    <v-row justify="center" class="pa-0">
      ...
      >
        <v-row align="center" justify="end" class="pa-4" style="height: 100%">
          <span
            class="text-h3 text-md-h2 white--text font-weight-bold text-right mt-4 mr-6 pl-4"
            >{{ tituloColeccion }}</span
          >
        </v-row>
      </v-col>
            ...
            <v-row>
              ...
              <v-col cols="11" class="px-0 mx-0" style="background: grey">
                <v-row justify="start" align="center" class="px-0 mx-0">
                  ...
                  >
                    <img
                      src="@/assets/img/colecciones_bg.jpg"
    ...
    <!-- Paginador -->
    <v-card-text>
      <v-row v-if="paginadoSize > 0" justify="start">
        <v-col cols="11" offset="1">
          ...
          <span v-for="(item, index) in current_section + 3" :key="index">
            <v-btn
              v-if="
                index < 3 && 3 * current_section + (index + 1) <= paginadoSize
              "
              class="mr-2"
              :color="
                3 * current_section + (index + 1) == current_page
                  ? 'primary'
                  : 'grey'
              "
              style="border-radius: 10px; padding: 27px 10px"
...
export default {
  ...
  methods: {
    ...
    async listarContenido() {
      let params = {
        colecciones: this.$route.params.id,
